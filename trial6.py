...
class DataEntryDialog(tk.Toplevel):
    def __init__(self, parent, title, fields):
        ...
        self.configure(bg='#FFA07A')  # Set background color
...
def setup_ui(window):
    ...
    style.configure('Custom.TFrame', background='#FFA07A')
    style.configure('Custom.TLabel', background='#FFA07A', foreground='#333333', font=('Arial', 12, 'bold'))
    style.configure('Custom.TEntry', background='#FFFFFF', fieldbackground='#FFFFFF', font=('Arial', 10))
    style.configure('Custom.TButton', background='#FF6347', foreground='#FFFFFF')
